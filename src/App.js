              ...
              {userInfo &&
                <>
                  <div className="flex justify-center px-5  -mt-12">
                    <img className="h-32 w-32 bg-white p-2 rounded-full " src={userInfo?.avatar} alt="profile pic" />
                  </div>
                  <div className=" ">
                    <div className="text-center px-14">
                      <h2 className="text-gray-800 text-3xl font-bold">Name - {userInfo?.first_name + " " + userInfo?.last_name}</h2>
                      <p className="text-gray-400 mt-2">E-mail - {userInfo?.email}</p>
                    </div>
                  </div>
                </>}
              {!userInfo &&
